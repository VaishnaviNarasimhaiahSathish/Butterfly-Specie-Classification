% Load the image data
imds = imageDatastore('/MATLAB Drive/deeplearning/DatasetComplete', 'IncludeSubfolders', true, 'LabelSource', 'foldernames');
...
if exist('alexnetcheck.mat', 'file')
